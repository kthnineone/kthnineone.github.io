...
The variance of sample mean is $$V(\bar{y}) = \frac{s^2}{n}(1-\frac{n}{N})$$ and standard error (SE) is the square root of estimated variance of $$\bar{y}$$ denoted as SE($$\bar{y}$$).<br>   
